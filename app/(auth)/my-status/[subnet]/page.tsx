                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div className="text-xl text-semibold text-left underline cursor-pointer">
                        Subnet{" "}
                        <span className={clsx(blur ? "blur-sm" : "blur-none")}>
                          {data.data.subnet}
                        </span>
                      </div>
                    </TooltipTrigger>
                    ...
                    >
                      <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-col gap-0">
                          ...
                          <div className="text-sm">
                            Tao In Pool: {showTaoNumber(data.data.taoInpool)} 𝞃
                          </div>
                          <div className="text-sm">
                            Alpha In Pool:{" "}
                  ...
                  <tr>
                    ...
                    {currency === "TAO" ? (
                      <td className="text-center py-2">
                        {showNumber(data.data.total_stake * data.data.price, 2)}{" "}
                    ...
                    {currency === "TAO" ? (
                      <td className="text-center py-2">
                        {showNumber(data.data.total_daily * data.data.price, 2)}{" "}
